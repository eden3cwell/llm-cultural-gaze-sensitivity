...
Import pattern in analysis scripts:
    import sys, os
...
_ANALYSIS    = os.path.dirname(_SHARED)
_NEW_EXP     = os.path.dirname(_ANALYSIS)
PROJECT_ROOT = os.path.dirname(_NEW_EXP)

DATA_DIR   = os.path.join(PROJECT_ROOT, "results", "new_experiment")
OUTPUT_DIR = os.path.join(PROJECT_ROOT, "outputs", "new_experiment")
...
MODEL_LABELS = {
    ...
    "Qwen2.5-VL-32B-Instruct":   "QwenVL-32B",
}
